...
% Term
\newcommand{\semester}{Sections 5 -- 8 --- Spring}
% Year
\newcommand{\myyear}{2026}
% Class Dates
\newcommand{\classdates}{January 12 -- May 6}
% Class Time
\newcommand{\classtimes}{Lecture, TR: \par \hspace{1.5cm} 1:15pm -- 2:30pm (Sections 005--006); \par \hspace{1.5cm} 2:50pm -- 4:05pm (Sections 006--007) \par \hspace{0.95cm} Recitation/Lab, MW: \par \hspace{1.5cm} 1:10pm -- 2:00pm (Section 005) \par \hspace{1.5cm} 2:20pm -- 3:31pm (Section 006) \par \hspace{1.5cm} 8:30am -- 9:20am (Section 007) \par \hspace{1.5cm} 9:40am -- 10:30am (Section 008)}
% Classroom
\newcommand{\classroom}{TR: LeConte 444 (All Sections); \par\hspace{1.8cm} MW: LeConte 101 (Sections 005--006), LeConte 122 (Sections 007--008)}
% Credits
\newcommand{\credits}{4}
% Instructor
...
\hspace{0.25cm} \begin{minipage}[b]{0.4\textwidth}
        ...
        \textit{Name:} Kosta Zigic \par
        \textit{Office:}  LeConte 439 \par
        \textit{Email:} \href{mailto:kzigic@email.sc.edu}{kzigic@email.sc.edu}
\end{minipage}\begin{minipage}[b]{0.4\textwidth}
        {\itshape Teaching Assistant Sections 007--008} \par
        \textit{Name:} Aisensen (Bowen) Han \par
...
\textit{Final Exam:} Thursday, April 30, 4:00pm (Sections 007--008) \par\hspace{2.0cm} Tuesday, May 5, 12:30pm (Sections 005--006)
\sectionbreak
...
The following is a \emph{tentative} schedule for the course and is subject to change. 
	...
	03/02 & Recitation & 04/23 & Polar Coordinates \\
