...
\question[16] Showing all your work, complete the following parts: 
	...
	\item Find the first-degree Taylor polynomial, $T_1(x)$, for $\ln x$ centered at $x= 5$. \par\vspace{0.3cm}
		...
		\]
		\[
		\psol{\boxed{T_1(x)= \ln 5 + \dfrac{1}{5} \, (x - 5)}}
		\] \par\vspace{0.3cm}
	...
	\psol{{\itshape We know from (b) that $R_1(x)= -\dfrac{1}{2c^2} \,(x - 5)^2$, where $c$ is between the center $5$ and $x$. If $x \in [3, 6]$, then it must be that $c \in [3, 6]$. But then\dots}}
		\[
		\psol{|R_1(x)|= \left| -\dfrac{1}{2c^2} \,(x - 5)^2 \right|= \dfrac{1}{2c^2} \cdot |x - 5|^2 \leq \dfrac{1}{2(3^2)} \cdot |3 - 5|^2= \dfrac{1}{2(3^2)} \cdot 2^2= \boxed{\dfrac{2}{9}= 0.222222}}
		\]
	\end{enumerate}
