...
\begin{itemize}
\item \hyperref[11-19]{11/19, Wednesday: Exam Review}
\item \hyperref[11-17]{11/17, Monday: $u$-Substitution}
\item \hyperref[11-14]{11/14, Friday: $u$-Substitution}
\item \hyperref[11-12]{11/12, Wednesday: Area between Curves}
...
% 12/05, Friday: Final Exam Review
\newpage
\section*{12/05, Friday: Final Exam Review\label{12-05}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.77

\item {\bfseries\itshape I liked the exam review}

\item {\bfseries\itshape This became one of my favorite classes even though I didn't do my best. Thanks for being a great prof}

\item {\bfseries\itshape Will there be double $u$-sub on final? Summer taught it in recitation}

\item {\bfseries\itshape Love the outfit} %forgot lights up

\item {\bfseries\itshape The print was kinda small} %what a way to end

\item {\bfseries\itshape Thanks for a good semester}


\item {\bfseries\itshape Thank you for an amazing semester! I hope to see you again for Calc II}

\item {\bfseries\itshape The refresh was nice}

\item {\bfseries\itshape Still don't like related rates}

\item {\bfseries\itshape I am sooo scared for the final this is my 3rd time taking this class :(}

\item {\bfseries\itshape Goat}

\item {\bfseries\itshape You're an awesome professor! I really hope that I get you next semester for Calc 2}

\item {\bfseries\itshape Was a good sem.}

\item {\bfseries\itshape Sweater!}

\item {\bfseries\itshape Thank you or being my favorite math teacher}

\item {\bfseries\itshape The final exam prep advice was nice}

\item {\bfseries\itshape I'm gonna miss you} %looking up at same moon

\end{itemize}


% 12/03, Wednesday: Final Exam Review
\newpage
\section*{12/03, Wednesday: Final Exam Review\label{12-03}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.65/10

\item {\bfseries\itshape Better grade please!} 

\item {\bfseries\itshape The review was nice}

\item {\bfseries\itshape Evil Larry}

\item {\bfseries\itshape Thank you for review instead of lecture}

\item {\bfseries\itshape Thank you for giving us the option for exam review time!}

\end{itemize}



% 12/01, Monday: Volumes by Slices
\newpage
\section*{12/01, Monday: Volumes by Slices\label{12-01}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.64/10

\item {\bfseries\itshape It was less examples than normal}

\item {\bfseries\itshape Confused about how we found the base length}

\item {\bfseries\itshape Hark, thy doth not understand}

\item {\bfseries\itshape The drawings showing the `pancakes' was most helpful} 

\item {\bfseries\itshape The drawings helped}

\item {\bfseries\itshape Computing volumes was good}

\item {\bfseries\itshape Some weird guy I've never seen before was sitting next to me}

\item {\bfseries\itshape Delightful class, excellent drawing}

\item {\bfseries\itshape Nah, I wasn't paying attention}
\end{itemize}

% 11/19, Wednesday: Exam Review
\newpage
\section*{11/19, Wednesday: Exam Review\label{11-19}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.89/10

\item {\bfseries\itshape The MVT makes sense}

\item {\bfseries\itshape The one joke was slept on}

\item {\bfseries\itshape I like choosing the examples}

\item {\bfseries\itshape I liked the IVT problem}

\item {\bfseries\itshape I wish we could have gone through more}

\item {\bfseries\itshape . . . - - - . . .}

\item {\bfseries\itshape Respectfully, James is like Winston Churchill and your [sic] like Kim Jong-Un}

\item {\bfseries\itshape I'm nervous}

\item {\bfseries\itshape Why don't you put these on Blackboard anymore?}

\item {\bfseries\itshape Do we have to include drawings on the exam?}

\item {\bfseries\itshape If we feel more comfortable doing basic interval notation on a problem like the ones today, will we have time to finish on the exam?}

\item {\bfseries\itshape Witcher 4?}

\item {\bfseries\itshape I am replaying Elden Ring, just got to Radahn. I love this game.}
\end{itemize}

% 11/17, Monday: $u$-Substitution
\newpage
\section*{11/17, Monday: $u$-Substitution\label{11-17}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.78/10

\item {\bfseries\itshape I did not quite understand shifting integrals}

\item {\bfseries\itshape Is using previous exams the best way of studying?} 

\item {\bfseries\itshape Batman}

\item {\bfseries\itshape Will we have to use $u$-sub for an area between curves?}

\item {\bfseries\itshape With all math I understand how to do the work but at the same time I don't really understand it. (if that makes sense) Tips?}

\item {\bfseries\itshape Do we need to know the last few examples for Calc I?}

\item {\bfseries\itshape How do you know if its a definite integral}

\item {\bfseries\itshape I like that there is no $u$-sub on the exam}

\item {\bfseries\itshape Will Riemann sums be on the exam? (the problems where we have to memorize those formulas)}
%\item {\bfseries\itshape } \phantom{.}\par
%	\begin{figure}[H]
%	\centering
%	\includegraphics[width=0.30\textwidth]{images/fatdog.png}
%	\end{figure} \par
\end{itemize}

% 11/14, Friday: $u$-Sub.
\newpage
\section*{11/14, Friday: $u$-Substitution\label{11-14}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.54/10

\item {\bfseries\itshape I liked the hoity-toidy method} Thanks! As I said, it is particularly useful come Calculus~II with trigonometric integrals. It's perhaps not the best name, but hoity-toity is the best name that I could come up with.

\item {\bfseries\itshape The examples} I hope that you found them helpful! If you have any questions about them, feel free to ask!

\item {\bfseries\itshape Ur a skinny king \Smiley} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/skinny.jpg}
	\end{figure} 

\item {\bfseries\itshape I liked the first way better} It is a bit more `familiar' as a method. However, as I said, the second approach to $u$-sub. tends to be better for trigonometric integrals in Calculus~II, so it is worth learning.

\item {\bfseries\itshape I liked the different methods} Now it's just a matter of practice until it really feels second nature to you. You got this!

\item {\bfseries\itshape How do you figure out what to sub for $u$?} That is the hard part! The rule of thumb is your choice of $u$ should have $du$ in the integrand---up to a multiple. Once that part is cancelled (or substituted), the new integral has to be one that you can actually do. That's the point of $u$-sub---to take an integral you don't know how to do and turn it into one that is `simpler.' 

\item {\bfseries\itshape That was very fast} Sorry that you found it fast. We will see more of it and you can always stop by for questions. I promise that with some time and effort that you got this!

\item {\bfseries\itshape Thank you for all the examples!} Always!

\item {\bfseries\itshape What was the linear $u$-sub thing?} We will talk a bit more about this. But in Calculus~II, you will have a linear $u$-sub in nearly every integral and sometimes you cannot avoid having one that `won't go away.' So, these you will have to be able to do in your head for speed. It's not that you have to be lightning fast, but you cannot be slow with them either.

\item {\bfseries\itshape Kinda easy examples} Well, it was the first day of $u$-sub!
\end{itemize}

% 11/12, Wednesday: Area between Curves
\newpage
\section*{11/12, Wednesday: Area between Curves\label{11-12}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.05/10

\item {\bfseries\itshape Not completing examples so we know how to finish them} The hard part is setting things up correctly. It's not that the integration is always easy, but it is harder to set things up correctly at the start. If there was more time, I might have integrated a few of them out to remind ya'll of the process. However, you can watch me do it until the cows come home but you only get good at the process and have it become routine for yourself by doing it for yourself. So, I gave you the answers so you could get that practice later!

\item {\bfseries\itshape } \phantom{.}\par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.40\textwidth]{images/cat.png}
	\end{figure} 
Love it! 

\item {\bfseries\itshape I feel like we are rushing through problems instead of explaining and working through the whole thing} The hard part is setting things up correctly. It's not that the integration is always easy, but it is harder to set things up correctly at the start. If there was more time, I might have integrated a few of them out to remind ya'll of the process. However, you can watch me do it until the cows come home but you only get good at the process and have it become routine for yourself by doing it for yourself. So, I gave you the answers so you could get that practice later! If you felt something was missing about the integral set-up, please, feel free to come and ask questions!

\item {\bfseries\itshape Please highlight when to start plugging in} For which step? If you're confused about something, please, feel free to ask questions! I am more than happy to help!

\item {\bfseries\itshape Thank you!} Anytime.

\item {\bfseries\itshape Examples, tips $+$ tricks visuals} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{images/tipsandtricks.png}
	\end{figure} 

\item {\bfseries\itshape itty bitty working space on paper} That paper wasn't meant to do the problems on---just to avoid having to copy them down!

\item {\bfseries\itshape \#lesbiancolors} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.25\textwidth]{images/lflag.png}
	\end{figure} \par
But also, how dare you attack my color schemes!

\item {\bfseries\itshape I liked going back over simpler methods} Glad that you liked it!

\item {\bfseries\itshape 67} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{images/hunt.png}
	\end{figure}

\item {\bfseries\itshape Not fully solving examples}  The hard part is setting things up correctly. It's not that the integration is always easy, but it is harder to set things up correctly at the start. If there was more time, I might have integrated a few of them out to remind ya'll of the process. However, you can watch me do it until the cows come home but you only get good at the process and have it become routine for yourself by doing it for yourself. So, I gave you the answers so you could get that practice later!

\item {\bfseries\itshape Can you go over area again please?} Sadly, this was the last day of area between curves. But if you still need help, that's perfectly understandable! Things come quickly at you in this course. You can always stop by for help!

\item {\bfseries\itshape The absolute value thing was helpful} Thanks! Just don't forget to practice it for yourself!

\item {\bfseries\itshape Please give practice HW sheets} I'm not sure what sheets you could be referring to? I have never given homework problems out in class. Do you mean something else?

\item {\bfseries\itshape $\star$ Your IP address here$\star$} Sure! Want my SS\# too? Mother's maiden name? 

\item {\bfseries\itshape This was very fast (I understand why though)} Sorry that you found it fast. You can always rewatch the lecture more at your own pace. If you need help, though, don't hesitate to reach out!

\item {\bfseries\itshape You are a good professor and people should laugh at your jokes more} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.35\textwidth]{images/clowns.png}
	\end{figure} \par
Agreed! \par

\item {\bfseries\itshape Is it possible to ``switch'' integration from $dy$ to $dx$ for every equation} In principle, yes. In practice, no. But whenever it is possible, you should try setting it up both ways. You will need to do this in later Calculus courses. You can always check if you are correct as the integral will have the same value either way---it's computing the same area!

\item {\bfseries\itshape Gay license $=$ REVOKED} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/revoke.png}
	\end{figure} 

\item {\bfseries\itshape No issues---I just need more consistent study. I've already spent hours preparing for exam 3. Just want to do okay} If you need help in the preparation, feel free to reach out! It will certainly be easier than Exam~2!

\item {\bfseries\itshape When doing area between curves, is a picture/sketch sufficient to show if a function is on top/bottom? Or do we have to work it out mathematically to show it?} Either is fine. It's more important---in this case---to be sure that you have it correct than to justify it. Just be careful, sketches can be deceiving if not done correctly!

\item {\bfseries\itshape I'm still confused on integrating $y$ vs. $x$ like $y= -x$ vs $x= 1$. (Top vs. bottom curves)} Instead of `top minus bottom', we have `right minus left.' We are still `filling the region with rectangles'---just horizontally. The height of the box is $dy$ and the width is the `right minus left.' This is like doing it `normally' where the box has width $dx$ and the height is `top minus bottom'.

\item {\bfseries\itshape Is there a step-by-step process to figure out the area computation from just the integral gives?} You mean computing the integral? It depends on the integral. But you're always finding an antiderivative and then find the difference of the upper and lower limit values. 

\item {\bfseries\itshape Kinda hard to follow} You can always rewatch the lecture at your own pace later! If you still have problems/confusions, feel free to reach out!

\item {\bfseries\itshape It's ranked fettuccine, udon, then angel hair. No other way} Incorrect\dots

\item {\bfseries\itshape What is integral for $\sec^{-1} x$ and $\csc^{-1} x$?} These are beyond the scope of our class. But if you really want to know, you can stop by!

\item {\bfseries\itshape } \phantom{.}\par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{images/alien.png}
	\end{figure} \par
My response: \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/app.jpeg}
	\end{figure}

\item {\bfseries\itshape } \phantom{.}\par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.35\textwidth]{images/steeler.png}
	\end{figure} \par
The only correct response\dots
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/delulu.png}
	\end{figure}

\item {\bfseries\itshape } \phantom{.} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/meow.png}
	\end{figure} \par
Hello Kitty.
...
\item {\bfseries\itshape } \phantom{.} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/skinny.png}
	\end{figure} \par

	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/skinny2.png}
	\end{figure} 
...
\item {\bfseries\itshape } \phantom{.} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/vampire.png}
	\end{figure} \par
Looks more like vampire man.

\item {\bfseries\itshape } \phantom{.} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/idk.png}
	\end{figure}
I\dots don't know how I feel about this\dots
\end{itemize}
...
\item {\bfseries\itshape Will a drawing of a graph be required on the exam when it comes to area between curves problems?} Problems can be given with or without a graph. You should also be able to do the problems with or without a graph. I would begin by using the diagrams but then trying them without them and then doing it with them and making sure that the solutions align.

\item {\bfseries\itshape The visuals were nice} Thanks! I hope that they were helpful for you! However, be sure that you can do problems with or without a diagram. I would begin by using the diagrams but then trying them without them and then doing it with them and making sure that the solutions align. 

\item {\bfseries\itshape It was nice to see different perspectives on computing areas} Not only is it `nifty', it is crucial for some problems. So, you should practice computing these areas `$dx$' and `$dy$' wherever possible. The answers should always align. 

\item {\bfseries\itshape The sideways one was weird} They can `feel' a bit odd. However, it can be crucial for some problems. So, you should practice computing these areas `$dx$' and `$dy$' wherever possible. The answers should always align. 

\item {\bfseries\itshape The graphs were helpful!} Thanks! I hope that they were helpful for you! However, be sure that you can do problems with or without a diagram. I would begin by using the diagrams but then trying them without them and then doing it with them and making sure that the solutions align. 
...
Love it! \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.40\textwidth]{images/cit_cup4.png}
	\end{figure}
\end{itemize}
...
\item {\bfseries\itshape The pictures were nice} Thanks. I'm not sure the one was really all that useful---but if it helped you!

\item {\bfseries\itshape When doing the formulas for shapes, can you briefly write the formula out before doing the Math? Visual learner and sometimes slow, lol. Thank you!} I'm not sure which formulas you are referring to? Unless this comment card got mixed up from a different class?

\item {\bfseries\itshape I found the lecture rather challenging so I'll go to tutoring to possibly help me better understand} Good for keeping up with things! But remember, I am always happy to help. It's easier to explain directly to you than a class. In class, I have to try for explanations that I think will work for a maximal number of people in the room. But one-on-one, we can work to find a discussion that works for you. 

\item {\bfseries\itshape The graphs were helpful} Glad that you found them useful! 

\item {\bfseries\itshape Fish slander!} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/antifish.jpg}
	\end{figure} 

\item {\bfseries\itshape I hope you were referencing HIMYM with ``General---'' What do you think of the ending of the show?} No. That is an old type of joke that way, wwaaayyyy precedes HIMYM (How I Met Your Mother). But I do like some of their nerdy jokes in the show. I liked it better `in the day.' But it is a \textit{hard} rewatch---it does not age well. The last few seasons were also not very good. I think it really went downhill about the time (spoiler) Robin and Barney begin their engagement.  

\item {\bfseries\itshape When is an integral indefinite and when is it definite?} The \textit{definite} integral has limits---because you \textit{definitely} know when to start/stop the integral. These integrals have a \textit{definite} region of integration and have a \textit{definite} number as their answer. An indefinite integral has no limits and instead asks the question, ``What is the most general antiderivative for this integrand?''
\end{itemize}
...
\item {\bfseries\itshape You moved so quick[ly]!} I'm sorry. I hope that it was still roughly understandable. Remember, you can always watch the lecture again, pausing to help it move at more your pace.

\item {\bfseries\itshape \Smiley} \Smiley

\item {\bfseries\itshape I understand how to antidifferentiate and solve integral problems!} You're new to the language, but it's important to be clear. We call the process integration or finding the antiderivative. The antiderivative is an object, not a process, i.e. it's a noun. But indeed! We use antiderivatives to compute definite integrals using the Fundamental Theorem of Calculus. 

\item {\bfseries\itshape I like the flashcards} Be sure to use them! The sooner you memorize your integrals, the easier things will be. Don't forget to review them before Calculus~II so that the course starts out smoother for you!

\item {\bfseries\itshape Pie slander!} \par
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/pumpkin.jpg}
	\end{figure} 

\item {\bfseries\itshape The end was a bit confusing, could you slow down?} I am sorry. I do try to move at a reasonable pace, but sometimes---especially at the end---I do just need to try to fit things into the lecture to stay on pace.

\item {\bfseries\itshape I liked the examples!} Glad you found them helpful! See how much it `clicked' by starting the homework soon!

\item {\bfseries\itshape You da best!} My mom says something similar\dots to my brother. 
\end{itemize}
...
\item {\bfseries\itshape I liked the explanations} Glad you found everything helpful! See if everything `clicked' by starting the homework\dots I am starting to feel like I'm all about that homework\dots

\item {\bfseries\itshape Maybe with the example we weren't able to complete, post videos working them all the way through} You can always try the other section lecture videos to see if it was covered completely in their lecture. Otherwise, we eventually always get around to it.

\item {\bfseries\itshape What's the highest level math course you could confidently teach?} I wouldn't say there is a peak. Eventually, it becomes about the field and not the `level.' For instance, I could teach a graduate level algebraic number theory course but not one in graduate graph theory as its not my area of expertise and it wouldn't be appropriate. So, anything at the 800/900 level or lower? Of course, as an instructor, our duties are more focused on the 100-300 level courses. 

\item {\bfseries\itshape Rock, paper, or scizzors? Black or white chess set?} You mean scissors? And I'm not sure I get the joke/reference? Also, chess sets always have white and black pieces\dots kinda part of the game. \Tongey

\item {\bfseries\itshape I understood how to find the area of integrals!} Great! See how much it `clicked' by starting the homework soon! This is especially true finding the area from the definition---though this will not be on Exam~3 or the final. 
\end{itemize}
...
\item {\bfseries\itshape Love the taco} I love tacos too, especially of the fish variety. Tucson has great tacos! But probably nothing like\dots LA tacos\dots \url{https://www.youtube.com/watch?v=oAbGPpQ3qx4}
	\begin{figure}[H]
	\centering
