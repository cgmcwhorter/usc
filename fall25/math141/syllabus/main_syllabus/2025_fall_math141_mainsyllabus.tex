...
\hspace{0.25cm} \begin{minipage}[b]{0.32\textwidth}
        ...
        \textit{Email:} TBD%\href{mailto:restrada@email.sc.edu}{restrada@email.sc.edu}
\end{minipage}\begin{minipage}[b]{0.35\textwidth}
        {\itshape Teaching Assistant Sections 25--28} \par
        \textit{Name:} TBD \par
        \textit{Office:}  TBD \par
        \textit{Email:} TBD%\href{mailto:emahan@email.sc.edu}{emahan@email.sc.edu}
\end{minipage}\begin{minipage}[b]{0.33\textwidth}
        {\itshape Teaching Assistant Sections 29--32} \par
        \textit{Name:} TBD \par
        \textit{Office:}  TBD \par
        \textit{Email:} TBD%\href{mailto:bcdial@email.sc.edu}{bcdial@email.sc.edu}
\end{minipage}
\pspace
