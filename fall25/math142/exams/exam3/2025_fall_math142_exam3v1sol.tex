...
\question[14] Showing all your work and fully justifying your reasoning, find the center, radius of convergence, and interval of convergence for each following power series: \par\vspace{0.2cm}
	\begin{parts}
	\part $\ds\sum_{n=0}^\infty n!\, (5x + 2)^n$ \pspace
	
	\vsol{\itshape The center is the solution to $5x + 2= 0$, i.e. $x= -\frac{2}{5}$. Using the Ratio Test, we have\dots
		\[
		\lim_{n \to \infty} \left| \dfrac{(n+1)! (5x + 2)^{n+1}}{n! (5x + 2)^n} \right|= \lim_{n \to \infty} |(n + 1) (5x + 2)|= \infty
		\]
	Because this limit cannot be less than 1 for any $x \neq -\frac{2}{5}$, the `interval' of convergence is simply $\{ -\frac{2}{5} \}$, so that the radius of convergence is $R= 0$.
		\[
		\boxed{
		\begin{gathered}
		\text{Center: } x= -\frac{2}{5} \\
		\text{`Interval' of Convergence: } \left\{ -\frac{2}{5} \right\} \\
		R= 0 
		\end{gathered}
		}
		\]
	...
	\part $\ds\sum_{n=0}^\infty (-1)^n \dfrac{x^n}{(2n)!}$ \pspace
	
	\vsol{\itshape It is immediate that the center is $x= 0$. Using the Ratio Test, we have\dots
		\[
		\hspace{-3.6cm}\lim_{n \to \infty} \left| \dfrac{\dfrac{x^{n+1}}{\big(2 (n + 1) \big)!}}{\dfrac{x^n}{(2n)!}} \right|= \lim_{n \to \infty} \left| \dfrac{x^{n+1}}{(2n + 2)!} \cdot \dfrac{(2n)!}{x^n} \right|= \lim_{n \to \infty} \left| \dfrac{x^{n+1}}{x^n} \cdot \dfrac{(2n)!}{(2n+2)(2n+1)(2n)!} \right|= \lim_{n \to \infty} \left| \dfrac{x}{(2n + 2)(2n + 1)} \right|= 0
		\]
...
\question[16] Showing all your work, complete the following: \par\vspace{0.2cm}
	\begin{parts}
	\part Find the Maclaurin series for $x \cos(x^3)$. \pspace
	
	\wsol{%
		\[
		\begin{aligned}
		\cos x&= \sum_{n=0}^\infty (-1)^n \, \dfrac{x^{2n}}{(2n)!} \\[0.3cm]
		\cos(x^3)&= \sum_{n=0}^\infty (-1)^n \, \dfrac{(x^3)^{2n}}{(2n)!}= \sum_{n=0}^\infty (-1)^n \, \dfrac{x^{6n}}{(2n)!} \\[0.3cm]
		x \cos(x^3)&= x \sum_{n=0}^\infty (-1)^n \, \dfrac{x^{6n}}{(2n)!}= \boxed{\sum_{n=0}^\infty (-1)^n \, \dfrac{x^{6n + 1}}{(2n)!}}
		\end{aligned}
		\]
	} \par\vspace{3.38cm}
	...
	\wsol{\itshape For $x \in (-1, 1)$, we know that $\ds\sum_{n=0}^\infty x^n= \dfrac{1}{1 - x}$ --- which will be true for its derivatives. In particular, the series and its derivatives are defined at $x= -\frac{1}{2}$. Therefore, we have\dots
		...
		\sum_{n=0}^\infty n \left(-\dfrac{1}{2} \right)^{n-1}= \boxed{\dfrac{4}{9}}
		\end{gathered}
		\]
	}
	...
	\part Replacing $\sin x$ with a Taylor series, compute $\ds\lim_{x \to 0} \dfrac{x - \sin x}{3x^3}$. [You will receive no credit for using l'H\^opital's rule. However, you may check your answer with it.] \pspace
	
	\wsol{%
		\[
		\begin{aligned}
		\lim_{x \to 0} \dfrac{x - \sin x}{3x^3}&= \lim_{x \to 0} \dfrac{x - \left(x - \frac{x^3}{3!} + \frac{x^5}{51} - \frac{x^7}{7!} + \cdots \right)}{3x^3} \\[0.3cm]
		&= \lim_{x \to 0} \dfrac{x - x + \frac{x^3}{3!} - \frac{x^5}{51} + \frac{x^7}{7!} - \cdots}{3x^3} \\[0.3cm]
		&= \lim_{x \to 0} \dfrac{\frac{x^3}{3!} - \frac{x^5}{51} + \frac{x^7}{7!} - \cdots}{3x^3} \\[0.3cm]
		&= \lim_{x \to 0} \dfrac{\frac{1}{3!} - \frac{x^2}{51} + \frac{x^5}{7!} - \cdots}{3} \\[0.3cm]
		&= \dfrac{\frac{1}{3!} - 0 + 0 - \cdots}{3} \\[0.3cm]
		&= \boxed{\dfrac{1}{18}}
		\end{aligned}
		\]
	}
...
\question[18] Showing all your work and fully justifying your reasoning, find the center, radius of convergence, and interval of convergence for the following power series:
	\[
	\sum_{n=1}^\infty \dfrac{(x - 59)^n}{8^n\, \sqrt{n}}
	\] \pspace
...
\vsol{\itshape\footnotesize The center is the $x$-value for which $x - 59= 0$, i.e. $x= 59$. To determine the interval of convergence, we can use the Ratio Test or the Root Test (using the fact that $\ds\lim_{n \to \infty} n^{1/n}= 1$):
	\[
	\begin{gathered}
	\hspace{-1.35cm} \text{Ratio Test: } \lim_{n \to \infty} \left|\dfrac{\;\;\dfrac{(x - 59)^{n+1}}{8^{n+1} \sqrt{n+1}}\;\;}{\dfrac{(x - 59)^n}{8^n\, \sqrt{n}}} \right|= \lim_{n \to \infty} \left| \dfrac{(x - 59)^{n+1}}{8^{n+1} \sqrt{n+1}} \cdot \dfrac{8^n \sqrt{n}}{(x - 59)^n} \right|= \lim_{n \to \infty} \left| \dfrac{(x - 59)^{n+1}}{(x - 59)^n} \cdot \dfrac{8^n}{8^{n+1}} \cdot \sqrt{\dfrac{n}{n+1}} \right|= \left| \dfrac{x - 59}{8} \right| \\[0.2cm]
	\text{Root Test: } \lim_{n \to \infty} \left| \dfrac{(x - 59)^n}{8^n \sqrt{n}} \right|^{1/n}= \lim_{n \to \infty} \left| \dfrac{x - 59}{8 n^{1/(2n)}} \right|= \lim_{n \to \infty} \left| \dfrac{x - 59}{8 (n^{1/n})^{1/2}} \right|= \left| \dfrac{x - 59}{8} \right|
	\end{gathered}
	\]
For either test to guarantee convergence, we need\dots
	\[
	\begin{gathered}
	\hspace{0.3cm}\left| \dfrac{x - 59}{8} \right| < 1 \\[0.2cm]
	-1 < \dfrac{x - 59}{8} < 1 \\[0.2cm]
	-8 < x - 59 < 8 \\[0.2cm]
	51 < x < 67
	\end{gathered}
	\]
...
\underline{$x= 51$}: If $x= 51$, then\dots
	\[
	\sum_{n=1}^\infty \dfrac{(x - 59)^n}{8^n\, \sqrt{n}}= \sum_{n=1}^\infty \dfrac{(51 - 59)^n}{8^n\, \sqrt{n}}= \sum_{n=1}^\infty \dfrac{(-8)^n}{8^n\, \sqrt{n}}= \sum_{n=1}^\infty \dfrac{(-1)^n 8^n}{8^n\, \sqrt{n}}= \sum_{n=1}^\infty \dfrac{(-1)^n}{\sqrt{n}}
	\]
...
\underline{$x= 67$}: If $x= 67$, then\dots
	\[
	\sum_{n=1}^\infty \dfrac{(x - 59)^n}{8^n\, \sqrt{n}}= \sum_{n=1}^\infty \dfrac{(67 - 59)^n}{8^n\, \sqrt{n}}= \sum_{n=1}^\infty \dfrac{8^n}{8^n\, \sqrt{n}}= \sum_{n=1}^\infty \dfrac{1}{\sqrt{n}}
	\]
But the series $\ds\sum_{n=1}^\infty \dfrac{1}{\sqrt{n}}$ diverges by the $p$-test with $p= \frac{1}{2}$. \par\vspace{0.3cm}

Therefore, the interval of convergence is $[51, 67)$. This implies that the radius of convergence is $R= \frac{67 - 51}{2}= \frac{16}{2}= 8$. 
		\[
		\boxed{
		\begin{gathered}
		\text{Center: } x= 59 \\
		\text{Interval of Convergence: } [51, 67) \\
		R= 8
		\end{gathered}
		}
		\]
