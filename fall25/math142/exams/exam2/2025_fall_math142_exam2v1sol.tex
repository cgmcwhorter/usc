...
\question[10] Showing all your work and fully justifying your reasoning, determine whether the following series diverges or converges. If the series converges, find its sum:
	\[
	\sum_{n=1}^\infty \dfrac{(-3)^{n+1}}{2^{2n}}
	\] \pspace

\vsol{\itshape Observe that\dots
	\[
	\sum_{n=1}^\infty \dfrac{(-3)^{n+1}}{2^{2n}}= \sum_{n=1}^\infty \dfrac{(-3)^n (-3)^1}{(2^2)^n}= \sum_{n=1}^\infty -3 \, \dfrac{(-3)^n}{4^n}= \sum_{n=1}^\infty -3\, \left( \dfrac{-3}{4} \right)^n
	\]
Because this series has the form $\sum ar^n$ with $a= -3$ and $r= -\frac{3}{4}$, the series is geometric. Because $|r|= \tfrac{3}{4} < 1$, the series $\ds\sum_{n=1}^\infty \dfrac{(-3)^{n+1}}{2^{2n}}$ converges by the Geometric Series Test. \pspace

We know that the sum of the series is $\dfrac{\;\;\text{first term}\;\;}{1 - r}$. But then\dots
	\[
	\sum_{n=1}^\infty \dfrac{(-3)^{n+1}}{2^{2n}}= \dfrac{\;\;\dfrac{(-3)^{1+1}}{2^{2(1)}}\;\;}{1 - \left(-\dfrac{3}{4} \right)}= \dfrac{9/4}{1 + \dfrac{3}{4}}= \dfrac{9/4}{7/4}= \dfrac{9}{\cancel{4}} \cdot \dfrac{\cancel{4}}{7}= \dfrac{9}{7}
	\]
}
...
\question[10] Showing all your work and fully justifying your reasoning, determine whether the following series converges or diverges:
	\[
	\sum_{n=1}^\infty \dfrac{n + 3}{\sqrt{4n^4 - 2}}
	\] 

\vsol{\itshape \small For `large' $n$, we know that $\dfrac{n + 3}{\sqrt{4n^4 - 2}} \approx \dfrac{n}{\sqrt{4n^4}}= \dfrac{n}{2n^2}= \dfrac{1}{2} \cdot \dfrac{1}{n}$, whose infinite series diverges by the $p$-test. Therefore, we predict the series $\ds\sum_{n=1}^\infty \dfrac{n + 3}{\sqrt{4n^4 - 2}}$ diverges. We know that the series $\ds\sum_{n=1}^\infty \dfrac{1}{n}$ (the Harmonic series) diverges by the $p$-test with $p= 1$. \pspace

Using the Limit Comparison Test, we limit compare to $\dfrac{1}{n}$. We have\dots
	\[
	\begin{aligned}
	\lim_{n \to \infty} \dfrac{\;\;\dfrac{n + 3}{\sqrt{4n^4 - 2}}\;\;}{\dfrac{1}{n}}&= \lim_{n \to \infty} \dfrac{n + 3}{\sqrt{4n^4 - 2}} \cdot \dfrac{n}{1} \\
	&= \lim_{n \to \infty} \dfrac{n^2 + 3n}{\sqrt{4n^4 - 2}} \cdot \dfrac{1/\sqrt{n^4}}{1/\sqrt{n^4}} \\
	&= \lim_{n \to \infty} \dfrac{\tfrac{n^2}{n^2} + \tfrac{3n}{n^2}}{\sqrt{\dfrac{4n^4 - 2}{n^4}}} \\
	&= \lim_{n \to \infty} \dfrac{1 + \tfrac{3}{n}}{\sqrt{4 - \tfrac{2}{n^4}}} \\
	&= \dfrac{1 + 0}{\sqrt{4 - 0}} \\
	&= \dfrac{1}{2}
	\end{aligned}
	\]
By the Limit Comparison Test because this limit is finite and nonzero, the series $\ds\sum_{n=1}^\infty \dfrac{n + 3}{\sqrt{4n^4 - 2}}$ has the same behavior as $\ds\sum_{n=1}^\infty \dfrac{1}{n}$, so that the series $\ds\sum_{n=1}^\infty \dfrac{n + 3}{\sqrt{4n^4 - 2}}$ diverges. \pspace

Alternatively, we can use the Direct Comparison Test. We have\dots
	\[
	\sum_{n=1}^\infty \dfrac{n + 3}{\sqrt{4n^4 - 2}} > \sum_{n=1}^\infty \dfrac{n}{\sqrt{4n^4}}= \sum_{n=1}^\infty \dfrac{n}{2n^2}= \dfrac{1}{2} \sum_{n=1}^\infty \dfrac{1}{n}
	\]
By the Direct Comparison Test because $\ds\sum_{n=1}^\infty \dfrac{1}{n}$ diverges, the series $\ds\sum_{n=1}^\infty \dfrac{n + 3}{\sqrt{4n^4 - 2}}$ diverges.}
...
\question[10] Showing all your work and fully justifying your reasoning, determine whether the following series converges or diverges:
	\[
	\sum_{n=1}^\infty \left( \dfrac{3n^2 + 5}{2n(n + 1)} \right)^n
	\] \pspace

\vsol{\itshape We use the Root Test:
	\[
	\hspace{-1cm} L:= \lim_{n \to \infty} \left| \left( \dfrac{3n^2 + 5}{2n(n + 1)} \right)^n \right|^{1/n}= \lim_{n \to \infty} \dfrac{3n^2 + 5}{2n(n + 1)}= \lim_{n \to \infty} \dfrac{3n^2 + 5}{2n^2 + 2n} \stackrel{\text{L.H.}}{=} \lim_{n \to \infty} \dfrac{6n}{4n + 2} \stackrel{\text{L.H.}}{=} \lim_{n \to \infty} \dfrac{6}{4}= \dfrac{3}{2} > 1
	\]
Because $L > 1$, the series $\ds\sum_{n=1}^\infty \left( \dfrac{3n^2 + 5}{2n(n + 1)} \right)^n$ diverges by the Root Test.}
...
\question[10] Showing all your work and fully justifying your reasoning, determine whether the following series converges or diverges:
	\[
	\sum_{n=1}^\infty \dfrac{n^2 + 5n - 2}{3n^4 - n + 1}
	\] \pspace

\vsol{\itshape For `large' $n$, we know that $\dfrac{n^2 + 5n - 2}{3n^4 - n + 1} \approx \dfrac{n^2}{3n^4}= \dfrac{1}{3} \cdot \dfrac{1}{n^2}$, whose infinite series converges by the $p$-test. Therefore, we predict that $\ds\sum_{n=1}^\infty \dfrac{n^2 + 5n - 2}{3n^4 - n + 1}$ converges. We know that the series $\ds\sum_{n=1}^\infty \dfrac{1}{n^2}$ converges by the $p$-test with $p= 2$. [In fact, $\ds\sum_{n=1}^\infty \dfrac{1}{n^2}= \dfrac{\pi^2}{6}$.] \pspace

Using the Limit Comparison Test, we limit compare to $\dfrac{1}{n^2}$. We have\dots
	\[
	\lim_{n \to \infty} \dfrac{\;\;\dfrac{n^2 + 5n - 2}{3n^4 - n + 1}\;\;}{\dfrac{1}{n^2}}= \lim_{n \to \infty} \dfrac{n^2 + 5n - 2}{3n^4 - n + 1} \cdot \dfrac{n^2}{1}= \lim_{n \to \infty} \dfrac{n^4 + 5n^3 - 2n^2}{3n^4 - n + 1}= \dfrac{1}{3}
	\]
By the Limit Comparison Test because this limit is finite and nonzero, the series $\ds\sum_{n=1}^\infty \dfrac{n^2 + 5n - 2}{3n^4 - n + 1}$ has the same behavior as $\ds\sum_{n=1}^\infty \dfrac{1}{n^2}$, so that the series $\ds\sum_{n=1}^\infty \dfrac{n^2 + 5n - 2}{3n^4 - n + 1}$ converges. \pspace

Alternatively, we can use the Direct Comparison Test. We have\dots
	\[
	\sum_{n=1}^\infty \dfrac{n^2 + 5n - 2}{3n^4 - n + 1} < \sum_{n=1}^\infty \dfrac{n^2 + 5n^2}{3n^4 - n^4}= \sum_{n=1}^\infty \dfrac{6n^2}{2n^4}= 3 \sum_{n=1}^\infty \dfrac{1}{n^2}
	\]
By the Direct Comparison Test because the series $\ds\sum_{n=1}^\infty \dfrac{1}{n^2}$ converges, the series $\ds\sum_{n=1}^\infty \dfrac{n^2 + 5n - 2}{3n^4 - n + 1}$ converges.}
...
\question[10] Showing all your work and fully justifying your reasoning, determine whether the following series converges or diverges:
	\[
	\sum_{n=0}^\infty \dfrac{n\, 2^n}{(2n)!}
	\] \pspace

\vsol{\itshape We use the Ratio Test:
	\[
	\begin{aligned}
	L:= \lim_{n \to \infty} \dfrac{\;\;\dfrac{(n+1)\, 2^{n + 1}}{\big(2(n + 1) \big)!}\;\;}{\dfrac{n\, 2^n}{(2n)!}}&= \lim_{n \to \infty} \dfrac{(n+1) 2^{n + 1}}{\big(2(n + 1) \big)!} \cdot \dfrac{(2n)!}{n\, 2^n} \\[0.3cm]
	&= \lim_{n \to \infty} \dfrac{(n+1)\, 2^{n + 1}}{(2n + 2)!} \cdot \dfrac{(2n)!}{n\, 2^n} \\[0.3cm]
	&= \lim_{n \to \infty} \dfrac{n + 1}{n} \cdot \dfrac{2^{n+1}}{2^n} \cdot \dfrac{(2n)!}{(2n + 2)!} \\[0.3cm]
	&= \lim_{n \to \infty} \dfrac{n + 1}{n} \cdot \dfrac{2^n \, 2}{2^n} \cdot \dfrac{(2n)!}{(2n + 2)(2n + 1)(2n)!} \\[0.3cm]
	&= \lim_{n \to \infty} \dfrac{n + 1}{n} \cdot \dfrac{\cancel{2^n} \, 2}{\cancel{2^n}} \cdot \dfrac{\cancel{(2n)!}}{(2n + 2)(2n + 1)\cancel{(2n)!}} \\[0.3cm]
	&= \lim_{n \to \infty} \dfrac{n + 1}{n} \cdot 2 \cdot \dfrac{1}{(2n + 2)(2n + 1)} \\[0.3cm]
	&= 1 \cdot 2 \cdot 0 \\[0.3cm]
	&= 0 < 1
	\end{aligned}
	\]
Because $L < 1$, the series $\ds\sum_{n=0}^\infty \dfrac{n\, 2^n}{(2n)!}$ is absolutely convergent by the Ratio Test.}
...
\question[10] Showing all your work and fully justifying your reasoning, determine whether the following series diverges or converges. If the series converges, find its sum:
	\[
	\sum_{n=0}^\infty \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right)
	\] \pspace

\vsol{\itshape Informally, we have\dots
	\[
	\begin{aligned}
	\sum_{n=0}^\infty \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right)&= \left( \dfrac{1}{2} - \dfrac{1}{3} \right) + \left( \dfrac{1}{3} - \dfrac{1}{4} \right) + \left( \dfrac{1}{4} - \dfrac{1}{5} \right) + \left( \dfrac{1}{5} - \dfrac{1}{6} \right) + \cdots \\
...
Formally, we know that\dots
	\[
	\sum_{n=0}^\infty \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right):= \lim_{N \to \infty} \sum_{n=0}^N \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right)
	\]
Observe that\dots
	\[
	\begin{aligned}
	\sum_{n=0}^N \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right)&= \left( \dfrac{1}{2} - \dfrac{1}{3} \right) + \left( \dfrac{1}{3} - \dfrac{1}{4} \right) + \cdots + \left( \dfrac{1}{N + 1} - \dfrac{1}{N + 2} \right) + \left( \dfrac{1}{N + 2} - \dfrac{1}{N + 3} \right) \\
...
Therefore, we have\dots
	...
	\begin{aligned}
	\sum_{n=0}^\infty \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right)&:= \lim_{N \to \infty} \sum_{n=0}^N \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right) \\
	&= \lim_{N \to \infty} \left( \dfrac{1}{2} - \dfrac{1}{N + 3} \right) \\
	&= \dfrac{1}{2} - 0 \\
	&= \dfrac{1}{2}
	\end{aligned}
	\]
Therefore, the series $\ds\sum_{n=0}^\infty \left( \dfrac{1}{n + 2} - \dfrac{1}{n + 3} \right)$ converges to $\frac{1}{2}$.}
