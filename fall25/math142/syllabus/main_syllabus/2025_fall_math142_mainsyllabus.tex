...
\textit{Office Hours:} \officehours \pvspace{0.25cm}

{\bfseries\color{scred} Teaching Assistant Information} \par \vspace{0.1cm}
\hspace{0.25cm} \begin{minipage}[b]{0.4\textwidth}
        \textit{Name:} Luke Hawranick \par
        \textit{Office:} LC 115 \par
        \textit{Email:} \href{mailto:hawranil@email.sc.edu}{hawranil@email.sc.edu}
\end{minipage}
\pspace
