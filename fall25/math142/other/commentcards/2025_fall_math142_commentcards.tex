...
\begin{itemize}
\item \hyperref[12-04]{12/04, Thursday: Final Exam Review}
\item \hyperref[12-02]{12/02, Tuesday: Final Exam Review}
\item \hyperref[11-18]{11/18, Tuesday: Exam Review}
\item \hyperref[11-13]{11/13, Thursday: Taylor Series Problems}
\item \hyperref[11-11]{11/11, Tuesday: Taylor Remainder Theorem}
\item \hyperref[11-06]{11/06, Thursday: Applications of Taylor Series}
\item \hyperref[11-04]{11/04, Tuesday: Taylor Series}
\item \hyperref[10-30]{10/30, Thursday: Power Series}
\item \hyperref[10-28]{10/28, Thursday: Power Series}
\item \hyperref[10-21]{10/21, Tuesday: Exam Review}
...
% 12/04, Thursday: Final Exam Review
\newpage
\section*{12/04, Thursday: Final Exam Review\label{12-04}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.73/10

\item {\bfseries\itshape Being able to review was helpful}

\item {\bfseries\itshape integration review was good!}

\item {\bfseries\itshape Trig Sub!}

\item {\bfseries\itshape Reviewing different types of stuff was nice}

\item {\bfseries\itshape Surprisingly, I will miss your jokes :(}

\item {\bfseries\itshape Don't hate on chihuahuas! I have one---Jack---and he's so cute everyone LOVES him!!} Jack propaganda 
\end{itemize}



% 12/02, Tuesday: Final Exam Review
\newpage
\section*{12/02, Tuesday: Final Exam Review\label{12-02}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.625/10

\item {\bfseries\itshape The practice was helpful}

\item {\bfseries\itshape The pace was good!}

\item {\bfseries\itshape I rather do the review than the new content}
\end{itemize}

% 11/18, Tuesday: Exam Review
\newpage
\section*{11/18, Tuesday: Exam Review\label{11-18}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.375/10

\item {\bfseries\itshape I hated the 67 joke}

\item {\bfseries\itshape \Smiley}

\item {\bfseries\itshape The remainder theorem is still confusing}

\item {\bfseries\itshape I'm stressed for the exam}

\item {\bfseries\itshape The practice problem choices were good}

\item {\bfseries\itshape I'm so bad at Calc}
\end{itemize}


% 11/13, Thursday: Taylor Remainder Theorem
\newpage
\section*{11/13, Thursday: Taylor Series Problems\label{11-13}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.5/10

\item {\bfseries\itshape Taylor series are hard} They certainly are a challenge and students typically find Taylor series-like problems, especially the Taylor Remainder Theorem, as one of the harder types of problems in the entire Calculus sequence. But there is good news: you got this! This just takes some time, thought, and practice. You have lots of resources to help you out too! Don't wait and stress, seek help if you need it!

\item {\bfseries\itshape Practice is helpful} Always! But also be careful of the write-up. The answer is important. But the work/write-up is importanter. 

\item {\bfseries\itshape Some of the transformations of the functions seen in very not clear or easy to derive} They certainly take some practice to get the process down as well as to figure out what you need to manipulate to get the desired result. If you're stuck on doing this, please, reach out for help!

\item {\bfseries\itshape Ur writing is small and hard to pick up the material} Always feel free to shout out if you need me to write larger!

\item {\bfseries\itshape The check-in \Sadey} They can be tricky. But remember, they aren't worth all that much and they are typically curved at the end. 

\item {\bfseries\itshape That remainder theorem still got me} They certainly are a challenge and students typically find Taylor series-like problems, especially the Taylor Remainder Theorem, as one of the harder types of problems in the entire Calculus sequence. But there is good news: you got this! This just takes some time, thought, and practice. You have lots of resources to help you out too! Don't wait and stress, seek help if you need it!
\end{itemize}

% 11/11, Tuesday: Taylor Remainder Theorem
\newpage
\section*{11/11, Tuesday: Taylor Remainder Theorem\label{11-11}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.63/10

\item {\bfseries\itshape Slightly lost} The Remainder Theorem is hard, so that's perfectly fine to be a bit lost. We will certainly see more of it. But if it doesn't start to `click', please, reach out for help! It's always easier to explain things one-on-one than in a group. 

\item {\bfseries\itshape What is the use for finding the remainder theorem or value of a series for us was unclear} We use Taylor series for approximations or computations in real life. But in practice, they are just that---approximations. Obviously, we want our approximations to be accurate, lest we make some serious errors. So, we need a way of keeping track of our worst possible error. This is what the Taylor Remainder Theorem does for us.

\item {\bfseries\itshape Why include stuff that we don't need to do?} I'm not sure that I had any of that in the lecture? It may be stuff that we didn't need \textit{right} then. But we will be seeing/using the Remainder Theorem more. 

\item {\bfseries\itshape Stop jumping around and just focus on explaining the step we're on} Sorry if it felt that way! I try to give the most coherent flow through a problem while also explaining the concepts. But when it's all new, it can certainly be a lot. 

\item {\bfseries\itshape I'm hungry} Me too fam, me too\dots

\item {\bfseries\itshape Stickers!} What stickers?

\item {\bfseries\itshape Ur a good professor} \dots not a great one?
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{images/cry.png}
	\end{figure}

\item {\bfseries\itshape Taylor series are hard} They certainly are a challenge and students typically find Taylor series-like problems, especially the Taylor Remainder Theorem, as one of the harder types of problems in the entire Calculus sequence. But there is good news: you got this! This just takes some time, thought, and practice. You have lots of resources to help you out too! Don't wait and stress, seek help if you need it!

\item {\bfseries\itshape Can you please post the most recent lectures on Blackboard?} I thought they already were! I will fix this right now.

\item {\bfseries\itshape What the hell even is a Taylor series?} It's like a polynomial approximation to a function, except that we use infinitely many terms. So, it's like an `infinite degree' polynomial approximation to a function. We do this because most functions are `hard' to compute or work with. But polynomials are nice! They have easy derivatives/integrals, are easy to evaluate, and are much better for solving equations. 
\end{itemize}

% 11/06, Thursday: Applications of Taylor Series
\newpage
\section*{11/06, Thursday: Applications of Taylor Series\label{11-06}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 7.1/10

\item {\bfseries\itshape I liked the Taylor series applications} Glad you enjoyed them! You will likely see several in your future major courses. 

\item {\bfseries\itshape The Thermo lecture was confusing} We will also do a special relativity example next class because I can't help myself---also, it was highly voted for as well. 

\item {\bfseries\itshape The tips and tricks were helpful} Thanks! Just be sure to practice things on your own to make sure things really `click' and that you can do problems at a decent pace. 

\item {\bfseries\itshape The last 10 minutes were HARD to understand} The Taylor Remainder Theorem problems are among the harder problems of the entire Calculus sequence. We will see more examples, but it definitely takes some `digesting time.' But you got this!

\item {\bfseries\itshape I don't think I get how we can manipulate infinite sums like that} It takes some practice and we will see more examples. To help with them, you can always create your own problems by starting with the function, plug in a valid value, and see the result on the `series side' (after simplifying), and seeing how you could maybe get from the series back to the function/value. In fact, this is mostly how we instructors create such examples.

\item {\bfseries\itshape This material was confusing} They certainly are a challenge and students typically find Taylor series-like problems, especially the Taylor Remainder Theorem, as one of the harder types of problems in the entire Calculus sequence. But there is good news: you got this! This just takes some time, thought, and practice. You have lots of resources to help you out too! Don't wait and stress, seek help if you need it!

\item {\bfseries\itshape Do you enjoy crushing our souls?} 
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{images/delight.png}
	\end{figure}
\end{itemize}

% 11/04, Tuesday: Taylor Series
\newpage
\section*{11/04, Tuesday: Taylor Series\label{11-04}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.0/10

\item [Literally, no written comments] Also, only three cards were turned in filled out\dots
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.50\textwidth]{images/am_i_joke.png}
	\end{figure}
\end{itemize}

% 10/30, Tuesday: Power Series
\newpage
\section*{10/30, Thursday: Power Series\label{10-30}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 9.13/10

\item {\bfseries\itshape What point does the center have if the radius is infinite? Does it mean anything?} A great question! A power series \textit{always} converges at its center and its value there is 0. In a sense, this is precisely what makes it the center. However, every real number is the center of the infinite interval $(-\infty, \infty)$. While being the center of $(-\infty, \infty)$ does not have much significance, being the center of a power series does in the precise sense we just mentioned. 

\item {\bfseries\itshape This was fun.} We haven't even gotten to the fun stuff yet! But glad that you liked it.

\item {\bfseries\itshape The final note of the power series operations was confusing} We will be seeing more examples in the future after Taylor series where it will hopefully make more sense.

\item {\bfseries\itshape Yah for Exam 2 grade!} Glad you did well then!

\item {\bfseries\itshape I just don't understand anything} Stop by and ask for help! It's always easier to get when it's being targeted/explained directly to you rather than an argument that is meant to be as understandable to a room. 
\end{itemize}

% 10/28, Tuesday: Power Series
\newpage
\section*{10/28, Tuesday: Power Series\label{10-28}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.92/10

\item {\bfseries\itshape [Thumbs Up]} Thanks! Though not the finger I am usually used to.

\item {\bfseries\itshape You showed us the three options} Make sure you are able to know the difference between each in terms of what needs to be done and the interval/radius of convergence. 

\item {\bfseries\itshape OkOk!}
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.30\textwidth]{images/alright.jpeg}
	\end{figure}

\item {\bfseries\itshape You mentioned how the center is ``what kills the series'' but I don't quite get what that means. [I check GitHub BTW \Smiley]} The center is the $x$-value that you plug in to make the summand 0, so that the sum is 0, i.e. the $x$-value that makes the infinite series $\ds\sum_{n=1}^\infty 0$. It is in that sense the $x$-value that ``kills the series.'' 

\item {\bfseries\itshape The motivation (even if fake) for the topic was nice} Glad that you found it helpful! We will see the real one soon enough!
\end{itemize}

% 10/21, Tuesday: Exam Review
\newpage
\section*{10/21, Tuesday: Exam Review\label{10-21}}

\begin{itemize}
\item {\bfseries\itshape Class Rating:} 8.93/10

\item {\bfseries\itshape Is it re-state terms more often} I am not sure what you mean. But if you are asking if you have to have sentences for your series conclusions, then yes. Every series problem should have at least one complete sentence summary. For direct/limit comparison, there should be at least two. For absolute/conditional convergence, there are at least three. Do you see why?

\item {\bfseries\itshape Amazing} Glad you liked it!

\item {\bfseries\itshape Practice is helpful, especially for the more rare series} Make sure to do plenty to get ready for the exam!
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.50\textwidth]{images/practice.png}
	\end{figure}

\item {\bfseries\itshape It was nice going through problems} You should get to see even more in recitation. Make sure to do plenty 

\item {\bfseries\itshape I'm really concerned for this exam!} You can always stop by for extra help or assessment! I can easily tell what you might be ready for or need more practice on and can give you extra practice!

\item {\bfseries\itshape I wish we had solved them out} You can always ask for that during recitation! It's important to be able to solve them, yes, but it's also important to be able to identify what `type' of problem a series is as well. 

\item {\bfseries\itshape The review was helpful} Thanks! Glad you found it helpful!

\item {\bfseries\itshape Thanks!} No problem. It's my job. 
\end{itemize}
