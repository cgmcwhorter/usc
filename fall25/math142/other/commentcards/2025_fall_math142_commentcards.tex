...
% 11/13, Tuesday: Taylor Remainder Theorem
\newpage
...
\item {\bfseries\itshape Taylor series are hard}

\item {\bfseries\itshape Practice is helpful}

\item {\bfseries\itshape Some of the transformations of the functions seen in very not clear or easy to derive}

\item {\bfseries\itshape Ur writing is small and hard to pick up the material}

\item {\bfseries\itshape The check-in \Frowney}

\item {\bfseries\itshape That remainder theorem still got me}
\end{itemize}
...
\item {\bfseries\itshape Slightly lost}
\item {\bfseries\itshape What is the use for finding the remainder theorem or value of a series for us was unclear}
\item {\bfseries\itshape Why include stuff that we don't need to do?}
\item {\bfseries\itshape Stop jumping around and just focus on explaining the step we're on}
\item {\bfseries\itshape I'm hungry}
\item {\bfseries\itshape Stickers!}
\item {\bfseries\itshape Ur a good professor} 
\item {\bfseries\itshape Taylor series are hard}
\item {\bfseries\itshape Can you please post the most recent lectures on Blackboard?}
\item {\bfseries\itshape What the hell even is a Taylor series?}
\end{itemize}
...
\item {\bfseries\itshape I liked the Taylor series applications}

\item {\bfseries\itshape The Thermo lecture was confusing}

\item {\bfseries\itshape The tips and tricks were helpful}

\item {\bfseries\itshape The last 10 minutes were HARD to understand}

\item {\bfseries\itshape I don't think I get how we can manipulate infinite sums like that}

\item {\bfseries\itshape This material was confusing}
