...
\sol{
	...
	% 1
	\draw[line width=0.03cm] (-2.33,0.50) -- (4.67,0.50);
	\draw[line width=0.03cm,fill=black] (-2.33,0.50) circle (0.1);
	\draw[line width=0.03cm,fill=white] (4.67,0.50) circle (0.1);
	\node at (-2.8,0.55) {\scalebox{0.6}{$n=1$}};
	% 2
	\draw[line width=0.03cm] (-1.17,0.75) -- (3.5,0.75);
	\draw[line width=0.03cm,fill=black] (-1.17,0.75) circle (0.1);
	\draw[line width=0.03cm,fill=white] (3.5,0.75) circle (0.1);
	\node at (-1.65,0.75) {\scalebox{0.6}{$n=2$}};
	% 3
	\draw[line width=0.03cm] (-0.78,1) -- (3.11,1);
	\draw[line width=0.03cm,fill=black] (-0.78,1) circle (0.1);
	\draw[line width=0.03cm,fill=white] (3.11,1) circle (0.1);
	\node at (-1.25,1) {\scalebox{0.6}{$n=3$}};
	% 10
	\draw[line width=0.03cm] (-0.23,1.25) -- (2.56,1.25);
	\draw[line width=0.03cm,fill=black] (-0.23,1.25) circle (0.1);
	\draw[line width=0.03cm,fill=white] (2.56,1.25) circle (0.1);
	\node at (-0.8,1.25) {\scalebox{0.6}{$n=10$}};
	% 100
	\draw[line width=0.03cm] (-0.02,1.5) -- (2.36,1.5);
	\draw[line width=0.03cm,fill=black] (-0.02,1.5) circle (0.1);
	\draw[line width=0.03cm,fill=white] (2.36,1.5) circle (0.1);
	\node at (-0.6,1.5) {\scalebox{0.6}{$n=100$}};
	
	% Labels
	\draw[line width=0.03cm] (-2.33,-0.2) -- (-2.33,0.2); \node at (-2.33,-0.4) {\scalebox{0.8}{$-1$}}; % -1
	\draw[line width=0.03cm] (4.67,-0.2) -- (4.67,0.2); \node at (4.67,-0.4) {\scalebox{0.8}{$2$}}; % 2
	\draw[line width=0.03cm] (2.33,-0.2) -- (2.33,0.2); \node at (2.33,-0.4) {\scalebox{0.8}{$1$}}; % 1
	\draw[line width=0.03cm] (0,-0.2) -- (0,0.2); \node at (0,-0.4) {\scalebox{0.8}{$0$}}; % 0
	\end{tikzpicture}
	\]
}
