...
\question[10] Showing all your work, compute the following limits: \par\vspace{0.3cm}
	...
	\scalebox{0.92}{$\ds\lim_{x \to 0} \dfrac{\sin^2(x)}{\cos(x) - 1}= \lim_{x \to 0} \dfrac{1 - \cos^2 x}{\cos(x) - 1}= \lim_{x \to 0} \dfrac{(1 - \cos x)(1 + \cos x)}{\cos x - 1}= \lim_{x \to 0} -(1 + \cos x)= -(1 + \cos 0)= -2$} \vspace{2.95cm}
