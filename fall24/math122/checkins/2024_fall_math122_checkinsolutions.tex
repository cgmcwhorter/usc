...
% 11/07
\checkin{11/07} $\ds \int \dfrac{1}{x} \;dx= \ln|x|$ \pspace
...
% 11/12
\checkin{11/12} $\ds\int_0^1 (3x^2 - x) \;dx= \dfrac{1}{2}$ \pspace
...
% 11/14
\checkin{11/14} Using the $u$-substitution $u= \sqrt{x}$ transforms the integral $\ds\int_0^4 2 \sqrt{x} \, e^{\sqrt{x}} \;dx$ into the integral $\ds\int_0^4 e^u \;du$. \pspace 
...
% 11/19
\checkin{11/19} To evaluate $\ds\int \dfrac{x^3 - x + 5}{x} \;dx$, one `should use' $u$-substitution. \pspace
