...
Based on the plot above, answer the following questions: 
	...
	\phantom{.} \hfill \begin{tikzpicture}[scale=0.75]
...
\question[15] Showing all your work, compute the derivatives given below. {\itshape Do not simplify your answer.} \pvspace{0.3cm}
	...
	\item $\dfrac{d}{dx} \left( \dfrac{(3x - 1) e^{2x}}{\ln(1 - x)} \right)= \dfrac{\big( 3 \cdot e^{2x} + 2e^{2x} \cdot (3x - 1) \big) - \left( \dfrac{1}{1 - x} \cdot -1 \right) \cdot \big( (3x - 1) e^{2x} \big)}{ \big( \ln(1 - x) \big)^2}$ \vfill
	\end{enumerate}
