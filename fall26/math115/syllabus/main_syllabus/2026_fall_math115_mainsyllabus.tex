...
% Course Title
\newcommand{\coursetitle}{Precalculus}
% Section
\newcommand{\coursesection}{}
% Term
\newcommand{\semester}{Sections 001 \& 007 --- Fall}
% Year
\newcommand{\myyear}{2026}
% Class Dates
\newcommand{\classdates}{August 18 -- December 14}
% Class Time
\newcommand{\classtimes}{Lecture: \par\hspace{1.5cm} Section 1: Tuesday/Thursday, 8:30am -- 9:45am \par\hspace{1.5cm} Section 7: Monday/Wednesday, 2:20pm -- 3:35pm \par Recitation: \par\hspace{1.5cm} Section 1: Monday/Wednesday, 8:30am -- 9:20am \par\hspace{1.5cm} Section 7: Tuesday/Thursday, 2:50pm -- 3:40pm}
% Classroom
\newcommand{\classroom}{Close-Hipp 450 (Lecture, Section 1) \par\hspace{1.85cm} Williams-Brice Building 125 (Recitation, Section 1) \par\hspace{1.85cm} Blatt PE Center (Lecture, Section 7) \par\hspace{1.85cm} Close-Hipp 201 (Recitation, Section 7)}
% Credits
\newcommand{\credits}{4}
...
\newcommand{\officehours}{Monday 10:00am -- 12:00pm, Wednesday 12:00pm -- 2:00pm}
...
\hspace{0.3cm} Artificial Intelligence Policy \dotfill \pageref{ai_policy} \par
...
% Course Information
\vspace{-0.1cm} \largeheader{0.5cm}{Basic Course Information}{course_info} \vspace{-0.3cm}
...
\textit{Final Exam:} Tuesday, December 8, 9:00am -- 11:30, Close-Hipp 450 (Section 1) \par\hspace{2cm} Friday, December 11, 12:30pm -- 3:00pm, Blatt PE Center 111 (Section 7)
\sectionbreak
...
Topics in algebra and trigonometry specifically needed for MATH 141, MATH 142, MATH 241. Subsets of the real line, absolute value; polynomial, rational, inverse, logarithmic, exponential functions; circular functions; analytic trigonometry. {\itshape Prerequisites: C or better in MATH 111or MATH 111I, or through placement exam.}
\sectionbreak
...
A student who successfully completes MATH 115 should be able to\dots
	\begin{itemize} \itemsep=0.3ex
	\item Increase their skills with algebra and trigonometry. Note that algebra skills are an important prerequisite for precalculus. Not all mistakes are created equal. You cannot begin many precalculus problems without necessary algebra skills.
	\item Work with mathematical terms such as linear, quadratic, exponential, logarithmic, inverse polynomial, rational, circular, and trigonometric functions and express these terms in correct context.
	\item Apply the methods of algebra to solve applications involving intercepts, rates of change, inequalities, systems of equations, rational functions, and interest growth.
	\item Develop various properties graphically and formulaically (domain, range, inverse functions, unit circle, Pythagorean identities, reciprocals, half-angle identities, double angle identities, and transformations).
	\item Students will tackle problems that require more than one step to solve.
	\end{itemize}
...
{\itshape\bfseries\color{scred}Textbook.} The textbook for this course is {\itshape Precalculus: A Unit Circle Approach (4th Ed)}, by Ratti, McWaters, and Skrzypek. However, the course will be run independent of the textbook; that is, students will \textit{not} need to purchase the textbook if they do not wish. Instead, students can make use of course notes, provided open-educational resources, additional provided materials, etc. in place of the textbook. \pspace

{\itshape\bfseries\color{scred}MyOpenMath.} Students will complete homework and possibly other course assignments using a homework system called MyOpenMath. This is an online assessment system through the non-profit MyOpenMath and will be integrated into the course through Blackboard. This system is free for students and students will not have to setup an account. The link to the homeworks can be found in the `Homework' folder on Blackboard. \pspace

{\itshape\bfseries\color{scred}Calculators.} Basic graphing calculators will often be allowed during the class, unless otherwise instructed. However, these will not be required. The course may make use of the computational engine Mathematica via the WolframAlpha website: \url{https://www.wolframalpha.com}. Although WolframAlpha does have a paid account option for additional resources, the course will not make use of these features and students {\itshape will not} be required to setup an account or make any kind of payment. The course may also make use of Symbolab: \url{https://www.symbolab.com/}. Calculators or other computational devices will not be allowed during check-ins, quizzes, exams, etc.
\par\vspace{0.4cm}
...
The course consists of four meetings per week. Two of these meetings will be lecture, where the material will be delivered, and two recitations, where students will have opportunities to engage in problem solving. There will be a check-in at the start of every class. Lectures will often have some time for individual/group problem solving as well. However, due to the number and `depth' of course topics, not every concept or problem type can be covered during class. Therefore, you may be assigned reading or videos before lecture. Lectures where readings or video are assigned will still cover course content; however, the focus of these lectures will often be problem-solving. Therefore, be sure to do the assigned reading/viewing before the lecture. Regardless, students are expected to spend outside of class reading course material, studying extra materials, and solving additional problems. Students are highly encouraged to do additional practice problems from past semesters available via the course webpage. Finally, students are expected to typically spend approximately 3~hours per credit outside of class on course materials. However, some weeks this may be more or less. 
\par\vspace{0.4cm}
...
It is important to not only learn the course material but also to understand how the topics can be applied to the real world. Therefore, throughout the semester, there will be a series of labs that will help students connect the mathematics in the course to practical applications. These labs may be done (partially or wholly) during class meetings or assigned to be completed outside of class. Often, these labs will be graded on the effort put into them; however, portions or the entirety of labs can be graded on the correctness of the work. Therefore, students should be sure to produce labs that are correct, organized, and presented well. The labs and their due dates will be announced during class. Late labs may not be accepted. 
\sectionbreak
...
There will be a ``check-in'' \textit{every} class. Often, they will consist of some statement that is either true or false. If a student indicates correctly whether the statement is true or false, a grade of 100\% is given; otherwise, an incorrect answer will receive a grade of 0\%. However, there will often be some type of option to indicate that the student does not know whether the statement is true or false, e.g. an ``IDK'' statement. {\itshape If the student chooses this ``I do not know'' option, a grade of 50\% will always be awarded.} If this 50\% option is available, then there is no mathematical grade benefit to guessing---though a student may guess if they want. \pspace

Check-ins will nearly always be based on some important or subtle fact from the material from the previous class or two. Check-ins are meant to be short, simple, and serve more as a way of gauging whether you are keeping up with the material. It is important that if you are late that you obtain a copy of the check-in immediately. Check-in solutions will often be discussed immediately following the check-in. Because check-in solutions will often be discussed in class, no make-up check-in will be given except under extraordinary circumstances determined on a case-by-case basis at the discretion of the instructor. Unless otherwise instructed, there are no calculators, computational devices, notes, or outside assistance of any kind allowed on check-ins. 
\sectionbreak
...
The only way to learn Mathematics is to do Mathematics! Therefore, there will be weekly homework assignments. Homeworks will mostly be given and submitted using MyOpenMath. MyOpenMath is a non-profit that hosts the open source IMathAS online assessment software. This online assessment system that will be integrated into the course through Blackboard. So, students will not have to create an account to access the homeworks. Moreover, students will not have to pay to access the homeworks. The homeworks can be found in the corresponding `Homework' folder in Blackboard. If you have difficulties in accessing this system or using the system during the semester, ask your instructor, teaching assistant, or other university technological consultant for assistance. Because homeworks will often be submitted electronically and students may experience difficulties with these systems, the internet, etc., do not wait until the last minute to begin or submit these assignments. \pspace
...
You are encouraged to work with others on homeworks. Mathematics is a social activity! The purpose of working together on assignments is to engage with course topics, see different perspectives, ask questions, and have others look over your work. However, do not simply use others to do your assignments. You should also not allow other students to use you to complete their assignments. Of course, using online solutions is a violation of the university's academic integrity policies. Furthermore, while AI may be able to help students in solving homework problems, you should not use AI for homework assignments, c.f. the `Artificial Intelligence' portion of the syllabus. Students that rely on AI tend to have trouble memorizing required materials, recalling/understanding course concepts, etc. Worse yet, students lose the experience in `struggling' through problems. Some struggle is natural in learning Mathematics---even important. This struggle is how students develop computation skills, learn problem solving skills, and build patience in problem solving---all extremely important skills for success in Mathematics. Using AI takes away the opportunity to learn from these experiences and build these mental `muscles.' Therefore, use of AI in the course without explicit written permission in advance is forbidden. Use of AI systems may result in an academic integrity violation. To avoid a possible academic integrity violation, if you are unsure of whether a particular resource is appropriate to use for any course content, consult with your instructor first. \pspace
...
There will be three exams in this course, each worth 15\% of the course grade, for a total of 45\% of the course grade. There will also be a final exam worth 20\% of the course grade. Together, all exams are worth 65\% of the course grade. The schedule of the exams can be found in the `Course Schedule' section of the syllabus. However, these exam dates are subject to change. Students should not make plans to leave campus or otherwise have conflicts on/before that date on/before class on November 19th for the Thanksgiving Break nor December 11th for the final exam. Exams will typically focus on that portion of the course's material. However, any course topics may appear on any exam. The final exam is cumulative and will cover the topics from the entire semester. Students should be present, seated, and prepared for a scheduled exam before the exam begins. Students who are late should not expect extra exam time. Furthermore, students who miss an exam should not expect to receive a make-up exam. There will be no make-up exams except under extraordinary circumstances, e.g. in the case of an emergency. However, determinations for make-up exams or other substitutions, with possible grade deductions, are made at the discretion of the instructor on a case-by-case basis. Unless otherwise instructed, no devices or materials other than those provided by the instructor are allowed on any exam. Exams may involve out-of-class portions, which will be submitted at a time and manner specified in lecture. Furthermore, it may be possible that any exam will be a take-home exam. In this case, the exam procedure and schedule will be announced in advance during lecture. There may be an opportunity for students to improve their exam grades at the end of the semester. If so, policies and procedures for this possible improvement will be announced later in the semester. 
\sectionbreak



% Artificial Intelligence Policy
\mysection{0.35}{Artificial Intelligence Policy}{ai_policy}

Students are forbidden from any use of artificial intelligence (AI) during the course for anything related to the course, including but not limited to course emails, classwork, check-ins, homeworks, labs, exams, etc. This course restriction on use of artificial intelligence includes but is not limited to LLM, generative models, narrow or general AI, applications or websites which make use of AI, etc. Artificial intelligence may be demonstrated by the instructor during the course for the purposes of student education, e.g. demonstrating the use, abuse, success, or failure of artificial intelligence related to course topics; however, this should not be taken as permission for the student to make any use of artificial intelligence. Any use of artificial intelligence by a student for anything related to the course must be pre-approved in writing by the primary course instructor \textit{before} its use and must be limited to the scope approved in the written requests. Violation of this policy may result in required re-submissions of materials or no credit awarded, in part or whole, to any materials found to be in violation of this policy. Additionally, this can result in further grade penalties, up to and including an `F' being awarded for the course as a whole. Determination of penalties for violations of this policy are based on the extent and nature of the violation and are made at the discretion of the instructor on a case-by-case basis. 
\sectionbreak
...
Assisting or attempting to assist (through intentional or unintentional action) another in any violation of the Honor Code. Other prohibited behaviors include:
	...
	\end{enumerate}
To best understand the parameters around copyright and intellectual property review \href{https://sc.edu/policies/ppm/acaf133.pdf}{ACAF 1.33 ``Intellectual Property Policy''} (\url{https://sc.edu/policies/ppm/acaf133.pdf}). \par\vspace{0.3cm}
...
Students may use the CircleIn app to study and help themselves and other students succeed in the course. Studying and learning alone is one of the hardest parts of a course, so please leverage one another. \par\vspace{0.3cm}
...
All USC students are expected to be familiar with and abide by the \href{https://sc.edu/about/offices_and_divisions/system_affairs/policies_and_procedures/system_manuals_and_handbooks/index.php}{Student Handbook} (\url{https://sc.edu/about/offices_and_divisions/system_affairs/policies_and_procedures/system_manuals_and_handbooks/index.php})---both for the University and their respective school/program. 
\sectionbreak
...
\mysection{0.24}{Important Dates}{univ_dates}
	...
	\begin{itemize}
	\item 08/24: Add/Drop Deadline
	\item 09/07: Labor Day (No Classes)
	\item 10/12: Midterm
	\item 10/15--10/16: Fall Break (No Classes)
	\item 11/03: Election Day (No Classes)
	\item 11/04: Withdraw Deadline
	\item 12/04: Last Day of Classes
	\item 12/07--12/14: Final Exams (Including Saturday)
	\end{itemize}

Students may find additional useful dates in the \href{https://sc.edu/about/offices\_and\_divisions/registrar/academic\_calendars/2025-26\_calendar.php} (\url{https://sc.edu/about/offices\_and\_divisions/registrar/academic\_calendars/2025-26\_calendar.php}). 
\sectionbreak
...
The following is a \emph{tentative} schedule for the course and is subject to change. \par\vspace{0.3cm}

Below is the schedule for Section~1.
...
Below is the schedule for Section~7.
        \begin{table}[!ht]
        \centering
        \scalebox{1}{%
        \begin{tabular}{ll || ll}
