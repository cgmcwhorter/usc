...
% 04/01
\checkin{04/01} The exponential function $f(x)= 3(2^{1-x})$ exponentially decreases. \pspace
...
% 04/02
\checkin{04/02} The exponential function $y= 15.3 (1.13)^x$ can be thought of as having an initial value of 15.3 and a growth rate of 13\%. \pspace
...
% 04/03
\checkin{04/03} The function which represents an initial value of \$50.55 that doubles in value every 7 years is $f(x)= 50.55 (2^{x/7})$. \pspace
...
% 04/07
\checkin{04/07} The continuous growth rate of $y= e^{0.03x}$ is $0.03$. \pspace
...
% 04/08
\checkin{04/08} $\log_5 \left( \dfrac{1}{25} \right)= -2$ \pspace
...
% 04/09
\checkin{04/09} For any base $b > 0$, $\log_b(1)= 0$ and $\log_b(b^x)= x$. \pspace
...
% 04/10
\checkin{04/10} The value of $\log_2(5)$ is the same as that of $\dfrac{\ln 5}{\ln 2}$. \pspace
...
% 04/14
\checkin{04/14} The amount in account after 5~years that initially contained \$120 and earns 4.1\% annual interest, compounded continuously is given by $120 e^{0.041(5)}$. \pspace
...
% 04/15
\checkin{04/15} If \$5,280 is invested at 0.1\% annual interest, compounded continuously, then it will take 20~years for the investment to be worth \$8,000. \pspace
...
% 04/16
\checkin{04/16} The function $y= 2^{1-x}$ is exponentially increasing. \pspace
