...
\newcommand{\coursenumber}{MATH 111I}
% Course Title
\newcommand{\coursetitle}{Intensive Basic College Mathematics}
% Section
\newcommand{\coursesection}{}
% Term
\newcommand{\semester}{Section 5 --- Spring}
% Year
\newcommand{\myyear}{2025}
% Class Dates
\newcommand{\classdates}{January 13 -- May 7}
% Class Time
\newcommand{\classtimes}{Lecture/Recitation, MW: 8:30am -- 9:20am; Lecture/Recitation, TR: 8:30am -- 9:45am}
% Classroom
\newcommand{\classroom}{MWTR: Close-Hipp 791}
% Credits
\newcommand{\credits}{4}
...
\newcommand{\officehours}{MWF: 12:00pm -- 1:00pm, TR 11:30am -- 12:30pm}
...
\hspace{0.3cm} Quizzes \dotfill \pageref{quizzes} \par
...
% Course Information
\vspace{0.5cm} \largeheader{0.5cm}{Basic Course Information}{course_info}
...
An intensive treatment of the topics covered in MATH 111. {\itshape Prerequisites: placement through the Math Assessment of Prerequisites (MAP).} \pspace

MATH 111 Catalog Description: Basic college algebra; linear and quadratic equations, inequalities, functions and graphs of functions, exponential and logarithm functions, systems of equations. {\itshape Prerequisites: placement through the Math Assessment of Prerequisites (MAP).}
\sectionbreak
...
A student who successfully completes Intensive Basic College Mathematics (MATH 111I) be able to\dots
	\begin{itemize} \itemsep=0.3ex
	\item Use basic mathematical notation and perform elementary calculations correctly and efficiently. Furthermore, students should be able to distinguish between expressions, equations, and functions. 
	\item Work effectively with functions: function notation, identifying independent and dependent variables, evaluation and application of functions, all in a variety of contexts. 
	\item Identify, use, and apply linear functions, including solving linear equations, finding and interpreting slopes, average rates of change, and intercepts. 
	\item Identify, use, and apply polynomial functions, including solving basic polynomial, i.e. quadratic, equations, finding and interpreting intercepts, factoring, especially difference of squares or sums of cubes, quadratics (including non-monic quadratics), factor-by-grouping, etc. 	
	\item Identify, use, and apply exponential and logarithmic functions, including solving exponential/logarithmic equations, finding and interpreting growth rates and intercepts, and understanding the differences between linear and exponential/logarithmic models.	
	\item Find equations of vertical, horizontal, parallel, and perpendicular lines. 
	\item Solve a system of linear equations graphically or using algebraic methods, e.g. substitution, elimination. Students should be able to apply these in special situations.
	\item Identify domains and ranges of functions, especially in a real-world context. 
	\item Apply function notation to compute their sums/differences, products/quotients, and composition.
	\item Graph functions and their translations and reflections. 
	\item Identify when a function has an inverse (one-to-one) and find this inverse in special cases (algebraically and graphically). 	
	\item Create and apply proportions. 
	\item Find the vertex form of a parabola and use it in application (both in the real-world and for identifying characteristics of quadratic functions).
	\item Solve quadratic equations using the vertex form, factoring, and the quadratic equation.
	\item Solve linear and some non-linear inequalities. Students should also be able to apply these in special cases.
	\item Create expressions to model real-world applications. 
	\end{itemize}
...
{\itshape\bfseries\color{scred}Textbook.} The textbook for this course is {\itshape Algebra Form and Function} 2nd ed. by McCallum, Connally, Hughes-Hallett, et al. Students may purchase a physical copy of the textbook; however, a more convenient option may be to purchase an ebook version of the textbook that comes along with the course homework system WileyPlus. \pspace

{\itshape\bfseries\color{scred}WileyPLUS.} Students will complete homework and possibly other course assignments using a homework system called WileyPLUS, which pairs with the course textbook. All students in the course will need to purchase access to this system for the semester. Instructions on creating a WileyPLUS account are found on Blackboarrd. The course ID is \textbf{B15598}. See also the website \url{https://education.wiley.com/ngonboard/index.html\#/Login}. \pspace

{\itshape\bfseries\color{scred}Calculators.} A graphing calculator is required for this course. The TI-83 or 84 is highly recommended and preferred. However, a TI-89, TI-Nspire CAS, or similar calculator with a computer algebra system will not be allowed during the course. The course may make use of the computational engine Mathematica via the WolframAlpha website: \url{https://www.wolframalpha.com}. Although WolframAlpha does have a paid account option for additional resources, the course will not make use of these features and students {\itshape will not} be required to setup an account or make any kind of payment. The course may also make use of Symbolab: \url{https://www.symbolab.com/}. 
\sectionbreak
...
% Quizzes
\mysection{0.18}{Quizzes}{quizzes}

There will be at least one quiz each week. These will be an opportunity to have a `higher stakes' opportunity to test your master of key course material before an exam. Quizzes will be fairly short---typically between ten and fifteen minutes. These will typically be on Thursday. However, this can vary on the week. While most quizzes will be announced, there may be unannounced quizzes during the course. These quizzes---announced or unannounced---may also occur online via Blackboard or using WileyPlus. If a quiz is given online, outside resources beyond a calculator without a CAS or other allowed materials is forbidden. Using other resources is a violation of the academic integrity policy. Make-up quizzes will only be given in the case of excused absences that are processed by the University, see the University Attendance Policy section to learn how to make these submissions. A make-up quiz for a quiz which occurred in-class must be made-up in-person, unless otherwise allowed. Other excused quizzes or make-ups, possibly with penalties, will be considered on a case-by-case basis at the discretion of the instructor. Students will have the opportunity to make-up a \textit{one pre-selected} quiz during the last full week of classes. More details on this opportunity will be given later in the semester. 
\sectionbreak
...
\mysection{0.37}{Artificial Intelligence Policy}{univ_artintel}
...
The following is a \emph{tentative} schedule for the course and is subject to change. 
	...
	01/30 & Linear Functions: 2.1--2.3 & 03/26 & Review \\
